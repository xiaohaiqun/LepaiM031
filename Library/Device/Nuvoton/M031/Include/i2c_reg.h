...
typedef struct
{
     ...
     * |        |          |When a new I2C state is present in the I2C_CTL_STATUS0 register, the SI flag is set by hardware.
     ...
     * |        |          |When the content of I2C_CTL_STATUS0 is F8H, no serial interrupt is requested.
     * |        |          |Others I2C_CTL_STATUS0 values correspond to defined I2C states.
     * |        |          |When each of these states is entered, a status interrupt is requested (SI = 1).
     * |        |          |A valid status code is present in I2C_CTL_STATUS0 one cycle after SI is set by hardware and is still present one cycle after SI has been reset by software.
...
#define I2C_CTL_STATUS0_STATUS_Pos           (0)                                               /*!< I2C_T::STATUS0: STATUS Position        */
#define I2C_CTL_STATUS0_STATUS_Msk           (0xfful << I2C_CTL_STATUS0_STATUS_Pos)                /*!< I2C_T::STATUS0: STATUS Mask            */
...
#define I2C_CTL_STATUS1_FULL_Pos             (4)                                               /*!< I2C_T::STATUS1: FULL Position          */
#define I2C_CTL_STATUS1_FULL_Msk             (0x1ul << I2C_CTL_STATUS1_FULL_Pos)                   /*!< I2C_T::STATUS1: FULL Mask              */

#define I2C_CTL_STATUS1_EMPTY_Pos            (5)                                               /*!< I2C_T::STATUS1: EMPTY Position         */
#define I2C_CTL_STATUS1_EMPTY_Msk            (0x1ul << I2C_CTL_STATUS1_EMPTY_Pos)                  /*!< I2C_T::STATUS1: EMPTY Mask             */

#define I2C_CTL_STATUS1_OVR_Pos              (6)                                               /*!< I2C_T::STATUS1: OVR Position           */
#define I2C_CTL_STATUS1_OVR_Msk              (0x1ul << I2C_CTL_STATUS1_OVR_Pos)                    /*!< I2C_T::STATUS1: OVR Mask               */

#define I2C_CTL_STATUS1_UDR_Pos              (7)                                               /*!< I2C_T::STATUS1: UDR Position           */
#define I2C_CTL_STATUS1_UDR_Msk              (0x1ul << I2C_CTL_STATUS1_UDR_Pos)                    /*!< I2C_T::STATUS1: UDR Mask               */

#define I2C_CTL_STATUS1_ONBUSY_Pos           (8)                                               /*!< I2C_T::STATUS1: ONBUSY Position        */
#define I2C_CTL_STATUS1_ONBUSY_Msk           (0x1ul << I2C_CTL_STATUS1_ONBUSY_Pos)                 /*!< I2C_T::STATUS1: ONBUSY Mask            */
