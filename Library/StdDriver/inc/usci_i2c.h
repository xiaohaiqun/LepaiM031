...
#define UI2C_CTL_STAR_INT_MASK         (0x002U)    /*!< Start condition received interrupt mask \hideinitializer */
 ...
 *    \hideinitializer
 */
#define UI2C_CTL_START(ui2c) ((ui2c)->PROTCTL = ((ui2c)->PROTCTL & ~UI2C_PROTCTL_PTRG_Msk) | UI2C_PROTCTL_STA_Msk)
